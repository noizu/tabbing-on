...
foundation) and the primary Rust multi-call binary (`rust/`, v0.2.0; its `plan/`
module is the voice-memo-to-ticket pipeline).
...
│   ├── PROJ-SCHEMA.md          #   State/config schema: TAB_* env, state files, theme blob, CLI grammar
│   ├── PROJ-SCHEMA.summary.md  #   Schema quick-reference
│   ├── PROJ-HOWTO.md           #   Task-oriented how-to index
...
├── merge-notes.md              # Branch-sweep / merge sequence notes (sep-1, 2026-09-01)
